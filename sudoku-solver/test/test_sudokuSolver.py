...
class SudokuTest(unittest.TestCase):
    ...
    def test_solvesExtremeSudoku(self):
        extremeSudoku = [[9, 0, 0,  0, 8, 5,  0, 0, 0],
                         [0, 6, 0,  1, 0, 0,  0, 0, 0],
                         [8, 0, 4,  0, 0, 0,  2, 1, 0],
        ...
        solvedSudoku = [[9, 7, 1,  2, 8, 5,  6, 3, 4],
                        [2, 6, 3,  1, 4, 9,  7, 5, 8],
                        [8, 5, 4,  7, 6, 3,  2, 1, 9],
        ...
        self.assertEqual(SudokuSolver.solver(solvedSudoku), solvedSudoku)
        self.assertEqual(SudokuSolver.solver(extremeSudoku), solvedSudoku)
